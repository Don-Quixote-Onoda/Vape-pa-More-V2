        ...
        <div class="card card-default chat">
            <div class="card-header">
                ...
                <div class="dropdown dropdown-chat-state">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        <li>
                            <a href="#" class="user-link">
                                <img src="{{ asset('images/user/user-sm-05.jpg') }}"
                                    alt="User Image">
            ...
            <div class="card-body pb-0" data-simplebar style="height: 363px;">
                ...
                <div class="media media-chat">
                    <img src="{{ asset('images/user/user-sm-01.jpg') }}" class="rounded-circle"
                        alt="Avata Image">
                ...
                <div class="media media-chat media-chat-right">
                    ...
                    <img src="{{ asset('images/user/user-sm-02.jpg') }}" class="rounded-circle"
                        alt="Avata Image">
                </div>
