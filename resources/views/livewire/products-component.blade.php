<div>
    ...
    <h1 class="my-3">Products Component</h1>

      <!-- Form Modal -->
      <button type="button" class="btn btn-primary my-3" data-toggle="modal" data-target="#productModal">
        Add Product
    </button>

    
    <table id="productsTable" class="table table-hover table-product mt-5 products-table d-none" style="width:100%">
        <thead>
            <tr>
                <th>Product Name</th>
                <th>Product Type</th>
